                              ...
                              <div class="row">
                                    ...
                                    ?>
                                          ...
                                          <div class="col">
                                                ...
                                                <input type="number" name="duration" id='duration' class="form-control" placeholder="Add total months" value="<?php echo $loan_duration; ?>"><br><br>

                                          </div>
                                    <?php
                                    } else {
                                    ?>
                                          <!-- <input type="hidden" name="duration" id='duration' class="form-control" placeholder="Add total months" value="<?php echo $loan_duration; ?>"><br><br> -->
                                    <?php
                                    }
                                    ?>
