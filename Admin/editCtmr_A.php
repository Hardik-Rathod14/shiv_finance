                ...
                <tbody id="tbody" align="center">
                    ...
                    ?>
                        ...
                        <tr id="delete<?php echo $row['id'] ?>">
                            ...
                            <!-- <td style="display:none;"><?php echo $cstid; ?></td> -->
            ...
            <div class="popup">
                <div class="modal__container" id="modal-container">
                    <div class="modal__content">
                        ...
                        <form action="popUpSubmit.php" id="popup" method="post">

                            <input type="number" name="amount" placeholder="Enter Amount" class="reg" required />
                            <br><br>
                            <button type="submit" class="modal__button modal__button-width"><span>Proceed</span><i class="bx bx-chevrons-right bx-fade-right"></i></button>
